...
@section('title', __('labels.pages.admin.users.title.change_password'))
        ...
        <form action="{{ route('admin.users.change_password', $user->id) }}" method="POST">
            ...
            <div class="card-body">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.pages.admin.users.title.change_password')</small>
                </h4>
                <hr>
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <button type="submit" class="btn btn-success btn-sm">@lang('labels.pages.admin.users.form.change_password_submit')</button>
                    </div>
                </div>
            </div>
        </form>
